/*import React from 'react'; // Tolto useState perché usiamo le Props!
import './AuthPopups.css';

// 1. Accettiamo le Props dall'alto dentro le parentesi graffe
          ...
          */  {/* POPUP DI LOGIN */}
          ...
          /*  {type==='login' ? (
            <>
                        ...
                        <form onSubmit={(e) => { e.preventDefault(); setIsLoggedIn(true); setIsLoginOpen(false); }}>
               ...
               */         {/* Sistemata la funzione di chiusura su setIsSignupOpen */}
                   /*     <button className="btn-chiudi" onClick={onClose}>X</button>
                        <h2>Registrati</h2>
                        <form onSubmit={(e) => { e.preventDefault(); setIsLoggedIn(true); setIsSignupOpen(false); }}>
                   */         {/* Trasformati tutti gli input in autochiudenti /> e class in className */}
                    /*        <input type="text" id="Nome" className="input-logreg" placeholder="Nome" required /> 
                            <input type="text" id="Cognome" className="input-logreg" placeholder="Cognome" required />
                            <input type="text" id="codiceFiscale" className="input-logreg" placeholder="Codice Fiscale" minLength="16" maxLength="16" required />
                            <input type="email" id="email" className="input-logreg" placeholder="Email" required />
                            <input type="password" id="Password" className="input-logreg" placeholder="Password" minLength="8" required />
                            <input type="password" id="ConfermaPassword" className="input-logreg" placeholder="Conferma Password" minLength="8" required />
